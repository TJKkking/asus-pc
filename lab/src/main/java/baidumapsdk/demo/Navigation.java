...
public class Navigation extends Activity {
    private final static String TAG = Navigation.class.getSimpleName();
    ...
    private void initMapStatus(){
        ...
        builder.target(new LatLng(40.048424, 116.313513)).zoom(15);//初始化坐标
    ...
    private void routePlanWithBikeParam() {
        BikeNavigateHelper.getInstance().routePlanWithRouteNode(bikeParam, new IBRoutePlanListener() {
            ...
            public void onRoutePlanSuccess() {
                ...
                intent.setClass(Navigation.this, BNaviGuideActivity.class);
    ...
    private void routePlanWithWalkParam() {
        WalkNavigateHelper.getInstance().routePlanWithRouteNode(walkParam, new IWRoutePlanListener() {
            ...
            public void onRoutePlanSuccess() {
                ...
                Intent intent = new Intent();
                intent.setClass(Navigation.this, WNaviGuideActivity.class);
                startActivity(intent);
