    ...
    private BDAbstractLocationListener mListener = new BDAbstractLocationListener(){
        public void onReceiveLocation(BDLocation location){
            if (null != location && location.getLocType() != BDLocation.TypeServerError){
                locResult = new LatLng(location.getLatitude(),location.getLongitude());
//                sb.append("\nlatitude : ");// 纬度
...
//                sb.append(location.getLongitude());
    ...
    public void searchButtonProcess(View v){
        ...
        // 设置起终点信息
        LatLng stLatLng = locResult;  //定位起点
        Intent intent =getIntent();
        //传入终点
        LatLng enLatLng = new LatLng(intent.getDoubleExtra("wd",24.90105),intent.getDoubleExtra("jd",102.773768));
        //set
    ...
    public void onGetWalkingRouteResult(WalkingRouteResult result){
        ...
        if (result.error != SearchResult.ERRORNO.NO_ERROR) {
            ...
            WalkingRouteOverlay overlay = new RoutePlan.MyWalkingRouteOverlay(mBaidumap);
    ...
    public void onGetTransitRouteResult(TransitRouteResult result){
        ...
        if (result.error == SearchResult.ERRORNO.NO_ERROR){
            ...
            if (result.getRouteLines().size() > 1) {
                ...
                if (!hasShownDialogue) {
                    RoutePlan.MyTransitDlg myTransitDlg = new RoutePlan.MyTransitDlg(RoutePlan.this,
                    ...
                    myTransitDlg.setOnItemInDlgClickLinster(new RoutePlan.OnItemInDlgClickListener() {
                        public void onItemClick(int position) {

                            route = nowResultransit.getRouteLines().get(position);
                            TransitRouteOverlay overlay = new RoutePlan.MyTransitRouteOverlay(mBaidumap);
                            mBaidumap.setOnMarkerClickListener(overlay);
                            routeOverlay = overlay;
                ...
                if (!hasShownDialogue) {
                    ...
                    myTransitDlg.setOnItemInDlgClickLinster(new RoutePlan.OnItemInDlgClickListener() {
                        public void onItemClick(int position) {
                            ...
                            DrivingRouteOverlay overlay = new RoutePlan.MyDrivingRouteOverlay(mBaidumap);
                            mBaidumap.setOnMarkerClickListener(overlay);
                            routeOverlay = overlay;
                ...
                if (!hasShownDialogue) {
                    ...
                    myTransitDlg.setOnItemInDlgClickLinster(new RoutePlan.OnItemInDlgClickListener() {
                        public void onItemClick(int position) {
                            ...
                            BikingRouteOverlay overlay = new RoutePlan.MyBikingRouteOverlay(mBaidumap);
                            mBaidumap.setOnMarkerClickListener(overlay);
                            routeOverlay = overlay;
    ...
    class MyTransitDlg extends Dialog {
        ...
        RoutePlan.OnItemInDlgClickListener onItemInDlgClickListener;
        ...
        public void setOnItemInDlgClickLinster(RoutePlan.OnItemInDlgClickListener itemListener) {
